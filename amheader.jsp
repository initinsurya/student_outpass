	...
	<div class="navigation">
		<div class=" nav1">
			<span class="menu"><i class="fa fa-bars" aria-hidden="true"></i></span>			     	
				 <ul>
					<li class="notch1"> </li><br>
					<li ><a href="am_home.jsp"><h4>Home&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4></a></li>


					<li><a href="index.jsp" ><h4>Logout</h4></a></li>		<br><br>					
				</ul>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-13" id="cl-effect-13">
						<ul class="nav navbar-nav">
							<li><a href="am_home.jsp">Home</a></li>
							<li><a href="attendance.jsp">Upload Attendance</a></li>
							<li><a href="eval.jsp">Evaluation</a></li>
